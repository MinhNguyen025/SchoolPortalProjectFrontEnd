...
const TeacherTimetable = () => {
  ...
  const retrieveTimeTableByTeacher = async () => {
    const response = await axios.get(
      "http://localhost:8080/api/timetable/fetch/teacher-wise?teacherId=" +
        teacher.id
    );
  ...
  useEffect(() => {
    const getTimeTableData = async () => {
      const res = await retrieveTimeTableByTeacher();
      if (res) {
        if (res.success) {
                            ...
                            {(() => {
                              if (
                                ...
                                return (
                                  <div>
                                    <b>
                                      {"G: " + timeSlotData.batch.grade.name}
                                      <br />
                                      {"B: " + timeSlotData.batch.name}
                                      <br />
                                      {"C: " + timeSlotData.course.name}
